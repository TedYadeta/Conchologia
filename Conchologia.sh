echo "Conchologia-v.0.0.40 - Glossary of Shell Commands"
...
# isoinfo, isovfy, isodump, systemd-cat,
...
# padsp, gtk-query-settings, cd-it8, canberra-gtk-play, mformat, glib-compile-schemas, gpgcompose, 
# mkzftree, lslocks, timedatectl, whiptail, perl, xsetpointer, expiry, iceauth, deja-dup,
# py3versions, apturl, showrgb, printerbanner, getent, alsabat, apt-key, start-pulseaudio-x11, 
# pkaction, ps2ascii, gdk-pixbuf-csource, lspgpot, mesg, xvidtune, axfer, 'Hello, world!'.startswith('Hello')

# lsinitramfs, ntfsfallocate, mdel, xdriinfo, last, printafm, setmetamode
#
# CNCHLG v.0.0.32 - (Monday, April 18th, 2022 - 8:45 PM) - Added avahi-set-host-name, ntfsls, 
# systemd-socket-activate, xset, bitmap, ntfswipe, kmodsign, gnome-terminal, fincore, dbus-send, 
# im-launch, ps2ps, apt-cache, 
#
# CNCHLG v.0.0.33 - (Tuesday, April 19th, 2022 - 1:57 PM) - Added avahi-publish-service, systemd-id128,
# xzcmp, cancel, totem-video-thumbnailer, ciptool, run-parts, bootctl, ps2pdf, ps2pdf12, ps2pdf13, ps2pdf14,
# grub-glue-efi, chage, hbpldecode, gpgparsemail, mutter, setfacl, slxdecode
#
# CNCHLG v.0.0.34 - (Wednesday, April 20th, 2022 - 8:59 PM) - Added gresource, xlsclients, vmware, 
# p11-kit, mcd, apport-but, apport-collect, lz4, unlz4, gs, xdg-user-dirs-update, gnome-logs, bzexe, 
# ippfind, lsipc, grub-mkrescue
#
# CNCHLG v.0.0.35 - (Thursday, April 21st, 2022 - 9:15 PM) - Added cd-fix-profile, ksh, shcomp2020, 
# apt-sortpkgs, hciconfig, debconf, hp-clean, gslp, gsbj, gsdj, gsdj500, gslj, 
#
# CNCHLG v.0.0.36 - (Sunday, April 24th, 2022 - 9:13 PM) - Added gst-inspect-1.0, prlimit, libnetcfg,
# pidof, prtstat, luit, ispell-wrapper, hp-levels, grub-mkstandalone, pax11publish
#
# CNCHLG v.0.0.37 - (Tuesday, April 28th, 2022 - 8:22 AM) - Added vmware-checkvm, xsetmode, aptdcon, 
# systemd-cgtop, strace-log-merge, gcalccmd, mako-render, mdu, xditview, gpg-zip, setleds, btmgmt, 
# nmcli, man-recode, savelog, cvtsudoers, unattended-upgrade, mountpoint, gedit, mdig, evince-previewer, 
# spd-say, ionice, pasuspender, ibus-setup, colormgr, mtr-packet, ntfsinfo, helpztags, qpdldecode, 
# lexgrog, gnome-calculator, gpgtar, catchsegv, zipdetails, add-apt-repository, esc-m, fc-cache, pdf2ps,
# gtf, pgrep, whatis, shotwell, chardet3, psicc, setlogcons, l2ping, ipptool, py3compile, remmina,
# mtype, rdma, foo2slx, pinentry-gnome3, paperconf, pdf2dsc, eqn, cvt, xorg, ipcs, lessfile, lesspipe, 
# showconsolefont, desktop-file-install, desktop-file-edit, dbus-update-activation-environment (reformatted),
# jpgicc, bwrap, instmodsh, aa-exec, x, hp-config_usb_printer, xmore, gpasswd, mmd, xmag, acpi_listen, 
# uuidgen, mandb, wpa_passphrase, fwupdtool, kernel-install
#
# CNCHLG v.0.0.38 - (Friday, April 29th, 2022 - 5:25 AM) - Added fc-cat, gnome-keyring, chfn, soelim, 
# move, startx, systemd-sysusers, pkcon, system-config-printer, gpg-connect-agent, pydoc3.8, smproxy, 
# gtk-encode-symbolic-svg, hostnamectl, ulockmgr_server, traceroute6, aa-enabled, foo2lava-wrapper, 
# select-default-iwrap, nmtui, hexdump, zjsdecode, gipddecode, fc-conflist, pstree, cheese, boltctl, 
# hex2hcd, h2ph, skill, rksh2020, rygel, lavadecode, setxkbmap, update-alternatives, grub-mkfont, 
# hp-check, evince, eutp, xephyr, systemd-tty-ask-password-agent, psfxtable, debconf-apt-progress,
# systemctl, tgz, xwininfo, debian-distro-info, loginctl, mousetweaks, xkbcomp, kbdinfo, xcmsdb, 
# min12xxw, foo2zjs-pstops, xvinfo, flock, ubuntu-report, ischroot, python, xeyes, apg, mshowfat, 
# nsenter, xdg-icon-resource, setupcon, pl2pm, ntfsrecover, getconf, mapscrn, pdffonts, hp-info, 
# duplicity, systemd-escape, usb-creator-gtk, xprop, ed, x11perfcomp, mcat, 
#
# CNCHLG v.0.0.39 - (Sunday, May 1st, 2022 - 6:35 AM) - Added dvipdf, arecord, aplay, grub-menulst2cfg, 
# totem, gapplication, pf2afm, perlbug, ubuntu-distro-info, faillog, git, git-upload-archive, ucs2any, 
# xzgrep, taskset, bzgrep, xlsatoms, xclipboard, gdbus, pldd, mimetype, gpg-agent, hp-makeuri, pwdx,
# deb-systemd-invoke, xrdb, xdpyinfo, xkbwatch, foo2qpdl, x11perf, pdftotext, lsb_release, btattach,
# delv, splitfont
#
# CNCHLG v.0.0.40 - (Monday, May 2nd, 2022 - 4:13 AM) - Added sbattach, lnstat, setfont, pod2text, 
# dpkg-trigger, transicc, thunderbird, apt-extracttemplates, pdfunite, gdb, podselect, hp-doctor, 
# intel-virtual-output, unopkg, bdftopcf, minfo, zipsplit, dbus-daemon, sg, grub-mkpasswd-pbkdf2, 
# dbxtool, gvfs-less, gnome-session-properties, ntfsfix, 
